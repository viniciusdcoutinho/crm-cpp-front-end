...
/**
 * JSX visual puro do card — sem hooks de dnd. Reutilizado pelo LeadCard
 * (na coluna) e pelo LeadCardOverlay (renderizado no DragOverlay).
 */
function LeadCardBody({ lead }: Props) {
...
/**
 * Card normal dentro de uma coluna do kanban. Sortable + opens modal no click.
 * Durante o drag, fica com opacidade reduzida (placeholder); o card que segue
 * o cursor e renderizado pelo LeadCardOverlay dentro do DragOverlay.
 */
...
/**
 * Versao do card pra ser renderizada dentro do DragOverlay. Sem hooks de
 * sortable, sem modal. Visualmente um pouco realcado (rotacao, sombra mais
 * forte) pra parecer "em movimento" sobrevoando as colunas.
 */
